...
class EntityFactory(private val assetManager: AssetManager, private val localAssetManager: AssetManager) {
    ...
    fun createBomb(listener: InputListener, onAutomaticBlowUp: (bomb: BombEntity) -> Unit) = BombEntity(soundFactory.getBombFuse(), soundFactory.getBombExplotion(), assetManager.get(Constant.Texture.Bomb.tName), assetManager.get(Constant.Texture.ExplodingBomb.tName), listener, onAutomaticBlowUp)
